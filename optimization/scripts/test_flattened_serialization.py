#!/usr/bin/env python3
"""
Test script to verify the refactored HorizonResults serialization works correctly.
...
def create_dummy_day_results(date_str = "20240101"):
    """Create a dummy HorizonResults instance for testing."""
    from solhycool_optimization import HorizonResults
    
    # Create dummy index (24 hours)
    start_time = pd.Timestamp(f"{date_str} 00:00:00")
...
def test_flattened_serialization():
    ...
    from solhycool_optimization import HorizonResults  # Import here to avoid issues
    
    print("Creating dummy HorizonResults...")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print("\\nReloading HorizonResults...")
        loaded_day_results = HorizonResults.initialize(output_file)
