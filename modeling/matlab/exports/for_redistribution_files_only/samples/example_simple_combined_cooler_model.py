#!/usr/bin/env python
"""
Sample script that uses the combined_cooler module created using
MATLAB Compiler SDK.
...
my_combined_cooler = combined_cooler.initialize()
...
Ce_kWeOut, Cw_lhOut, detailedOut = my_combined_cooler.combined_cooler_model(Tamb_CIn, HR_ppIn, mv_kghIn, qc_m3hIn, RpIn, RsIn, wdcIn, wwctIn, TvIn, nargout=3)
print(Ce_kWeOut, Cw_lhOut, detailedOut, sep='\n')

my_combined_cooler.terminate()
